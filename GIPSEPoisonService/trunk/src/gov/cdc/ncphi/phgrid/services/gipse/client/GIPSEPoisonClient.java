...
import gov.cdc.ncphi.phgrid.services.gipse.stubs.GIPSEPoisonPortType;
import gov.cdc.ncphi.phgrid.services.gipse.stubs.service.GIPSEPoisonServiceAddressingLocator;
import gov.cdc.ncphi.phgrid.services.gipse.common.AxisUtils;
import gov.cdc.ncphi.phgrid.services.gipse.common.GIPSEPoisonI;
 ...
 */
public class GIPSEPoisonClient extends GIPSEPoisonClientBase implements GIPSEPoisonI {	

	public GIPSEPoisonClient(String url) throws MalformedURIException, RemoteException {
		this(url,null);	
	}

	public GIPSEPoisonClient(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	}
	
	public GIPSEPoisonClient(EndpointReferenceType epr) throws MalformedURIException, RemoteException {
	   	this(epr,null);
	}
	
	public GIPSEPoisonClient(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
	}

	public static void usage(){
		System.out.println(GIPSEPoisonClient.class.getName() + " -url <service url>");
	}
	...
	public static void main(String [] args){
		...
		if(!(args.length < 2)){
			if(args[0].equals("-url")){
			  GIPSEPoisonClient client = new GIPSEPoisonClient(args[1]);
	...
	private static void testMetadata(String [] args) throws Exception{
		  System.out.println("In client...OOOOOOO");
		  GIPSEPoisonClient client = new GIPSEPoisonClient(args[1]);
