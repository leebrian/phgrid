 ...
 * 
 */
public abstract class GIPSEPoisonResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(GIPSEPoisonResourceBase.class);

	private GIPSEPoisonResourceConfiguration configuration;
    ...
    public GIPSEPoisonResourceBase() {
    }
	...
	public GIPSEPoisonResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (GIPSEPoisonResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
