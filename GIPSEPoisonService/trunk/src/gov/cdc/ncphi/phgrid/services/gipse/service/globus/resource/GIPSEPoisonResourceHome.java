...
import gov.cdc.ncphi.phgrid.services.gipse.stubs.GIPSEPoisonResourceProperties;
 ...
 * 
 */
public class GIPSEPoisonResourceHome extends SingletonResourceHomeImpl implements Initializable {

	static final Log logger = LogFactory.getLog(GIPSEPoisonResourceHome.class);
    private static final UUIDGen UUIDGEN = UUIDGenFactory.getUUIDGen();

	public Resource createSingleton() {
		logger.info("Creating a single resource.");
		try {
		    GIPSEPoisonResourceProperties props = new GIPSEPoisonResourceProperties();
			GIPSEPoisonResource resource = new GIPSEPoisonResource();
			if (resource instanceof PersistenceCallback) {
                  ...
                  try{
                    ((PersistenceCallback) resource).load(null);
			          ...
			          resource.initialize(props, GIPSEPoisonConstants.RESOURCE_PROPERTY_SET, UUIDGEN.nextUUID());
			      }
            } else {
                    resource.initialize(props, GIPSEPoisonConstants.RESOURCE_PROPERTY_SET, UUIDGEN.nextUUID());
            }
	...
	public Resource find(ResourceKey key) throws ResourceException {
		GIPSEPoisonResource resource = (GIPSEPoisonResource) super.find(key);
		return resource;
	}
     ...
     */
    public GIPSEPoisonResource getAddressedResource() throws Exception {
        GIPSEPoisonResource thisResource;
        thisResource = (GIPSEPoisonResource) ResourceContext.getResourceContext().getResource();
        return thisResource;
    }
}