 ...
 * 
 */
public abstract class GIPSEServiceResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(GIPSEServiceResourceBase.class);

	private GIPSEServiceResourceConfiguration configuration;
    ...
    public GIPSEServiceResourceBase() {
    }
	...
	public GIPSEServiceResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (GIPSEServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
