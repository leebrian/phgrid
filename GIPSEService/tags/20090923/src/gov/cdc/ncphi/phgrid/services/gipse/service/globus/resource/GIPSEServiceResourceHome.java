package gov.cdc.ncphi.phgrid.services.gipse.service.globus.resource;

import gov.cdc.ncphi.phgrid.services.gipse.common.GIPSEServiceConstants;
import gov.cdc.ncphi.phgrid.services.gipse.stubs.GIPSEServiceResourceProperties;
 ...
 * 
 */
public class GIPSEServiceResourceHome extends SingletonResourceHomeImpl implements Initializable {

	static final Log logger = LogFactory.getLog(GIPSEServiceResourceHome.class);
    private static final UUIDGen UUIDGEN = UUIDGenFactory.getUUIDGen();

	public Resource createSingleton() {
		logger.info("Creating a single resource.");
		try {
		    GIPSEServiceResourceProperties props = new GIPSEServiceResourceProperties();
			GIPSEServiceResource resource = new GIPSEServiceResource();
			if (resource instanceof PersistenceCallback) {
                  ...
                  try{
                    ((PersistenceCallback) resource).load(null);
			          ...
			          resource.initialize(props, GIPSEServiceConstants.RESOURCE_PROPERTY_SET, UUIDGEN.nextUUID());
			      }
            } else {
                    resource.initialize(props, GIPSEServiceConstants.RESOURCE_PROPERTY_SET, UUIDGEN.nextUUID());
            }
	...
	public Resource find(ResourceKey key) throws ResourceException {
		GIPSEServiceResource resource = (GIPSEServiceResource) super.find(key);
		return resource;
	}
     ...
     */
    public GIPSEServiceResource getAddressedResource() throws Exception {
    	GIPSEServiceResource thisResource;
        thisResource = (GIPSEServiceResource) ResourceContext.getResourceContext().getResource();
        return thisResource;
    }
}