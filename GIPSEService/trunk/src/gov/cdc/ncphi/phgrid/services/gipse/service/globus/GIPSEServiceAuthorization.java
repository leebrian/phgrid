 ...
 * 
 */
public class GIPSEServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://gipse.services.phgrid.ncphi.cdc.gov/GIPSEService";
	
	Map authorizationClassMap = new HashMap();
	
	
	public GIPSEServiceAuthorization() {
	}
	...
	public void authorizeQueryMetadata(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
		
	}
	   				
	public void authorizeQueryGIPSE(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("getMultipleResourceProperties")){
			...
			return true;
		} else if(operation.getLocalPart().equals("queryMetadata")){
			authorizeQueryMetadata(peerSubject, context, operation);
			return true;
		} else if(operation.getLocalPart().equals("queryGIPSE")){
			authorizeQueryGIPSE(peerSubject, context, operation);
			return true;
		} 		
		return false;
	}
