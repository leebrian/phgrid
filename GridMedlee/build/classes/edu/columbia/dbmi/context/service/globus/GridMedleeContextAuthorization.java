 ...
 * 
 */
public class GridMedleeContextAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://dbmi.columbia.edu/GridMedlee/Context";
	
	
	public GridMedleeContextAuthorization() {
	}
	...
	public static void authorizeGetOutputDocuments() throws RemoteException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		} else if(operation.getLocalPart().equals("getOutputDocuments")){
			try{
				authorizeGetOutputDocuments();
				return true;
			} catch (Exception e){
				e.printStackTrace();
				return false;
