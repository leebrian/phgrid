 ...
 * 
 */
public class GridMedleeContextResourceHome extends ResourceHomeImpl {
	...
	public ResourceKey createResource() throws Exception {
		...
		GridMedleeContextResource resource = (GridMedleeContextResource) createNewInstance();
		// Create the resource properties bean so that the resource can use it to hold the  resource property values
		GridMedleeContextResourceProperties props = new GridMedleeContextResourceProperties();
        ...
        resource.initialize(props, GridMedleeContextConstants.RESOURCE_PROPERTY_SET, id);
 	...
 	*/
	public edu.columbia.dbmi.context.stubs.types.GridMedleeContextReference getResourceReference(ResourceKey key) throws Exception {
 	...
 	*/	
	public GridMedleeContextResource getResource(ResourceKey key) throws ResourceException {
		GridMedleeContextResource thisResource = (GridMedleeContextResource)find(key);
		return thisResource;
	}
     ...
     */
    public GridMedleeContextResource getAddressedResource() throws Exception {
        GridMedleeContextResource thisResource;
        thisResource = (GridMedleeContextResource) ResourceContext.getResourceContext().getResource();
        return thisResource;
    }
