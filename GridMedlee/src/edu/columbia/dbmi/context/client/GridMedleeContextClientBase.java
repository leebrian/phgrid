 ...
 */
public abstract class GridMedleeContextClientBase extends ServiceSecurityClient implements NotifyCallback {	
	protected GridMedleeContextPortType portType;
	...
	public GridMedleeContextClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public GridMedleeContextClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
	...
	private GridMedleeContextPortType createPortType() throws RemoteException {

		GridMedleeContextServiceAddressingLocator locator = new GridMedleeContextServiceAddressingLocator();
		...
		GridMedleeContextPortType port = null;
		try {
			port = locator.getGridMedleeContextPortTypePort(getEndpointReference());
		} catch (Exception e) {
