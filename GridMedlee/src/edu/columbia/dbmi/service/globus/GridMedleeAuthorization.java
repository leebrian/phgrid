 ...
 * 
 */
public class GridMedleeAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://dbmi.columbia.edu/GridMedlee";
	
	
	public GridMedleeAuthorization() {
	}
	...
	public static void authorizeInvokeGridMedlee() throws RemoteException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		} else if(operation.getLocalPart().equals("invokeGridMedlee")){
			try{
				authorizeInvokeGridMedlee();
				return true;
			} catch (Exception e){
				e.printStackTrace();
				return false;
