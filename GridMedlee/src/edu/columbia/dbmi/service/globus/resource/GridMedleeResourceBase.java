 ...
 * 
 */
public abstract class GridMedleeResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  {

	static final Log logger = LogFactory.getLog(GridMedleeResourceBase.class);

	private GridMedleeResourceConfiguration configuration;
	...
	public GridMedleeResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (GridMedleeResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
