...
public class RetrieveDataResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the transferServiceContextReference value for this RetrieveDataResponse.
     * 
    ...
    /**
     * Sets the transferServiceContextReference value for this RetrieveDataResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RetrieveDataResponse)) return false;
        RetrieveDataResponse other = (RetrieveDataResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RetrieveDataResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://transfer.cagrid.org/TransferService", ">RetrieveDataResponse"));
