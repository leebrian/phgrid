...
-- Table: gipse_indicator_classifiers

-- DROP TABLE ${db.schema}.gipse_indicator_classifiers;
...
(
  ...
  CONSTRAINT "PK_indicator_classifiers" PRIMARY KEY (classifier_id)
)
WITHOUT OIDS;

ALTER TABLE ${db.schema}.gipse_indicator_classifiers OWNER TO ${db.owner};
