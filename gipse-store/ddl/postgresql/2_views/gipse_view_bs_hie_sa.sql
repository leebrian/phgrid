 ...
 */
-- View: gipse_view_bs_hie_sa

-- DROP VIEW ${db.schema}.gipse_view_bs_hie_sa;

CREATE OR REPLACE VIEW ${db.schema}.gipse_view_bs_hie_sa AS 
...
ALTER TABLE ${db.schema}.gipse_view_bs_hie_sa OWNER TO ${db.owner};
