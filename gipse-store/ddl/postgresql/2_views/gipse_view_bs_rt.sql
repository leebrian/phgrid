 ...
 */
-- View: gipse_view_bs_rt

-- DROP VIEW ${db.schema}.gipse_view_bs_rt;

CREATE OR REPLACE VIEW ${db.schema}.gipse_view_bs_rt AS 
...
ALTER TABLE ${db.schema}.gipse_view_bs_rt OWNER TO ${db.owner};
