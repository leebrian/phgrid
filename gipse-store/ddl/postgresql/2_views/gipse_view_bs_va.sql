 ...
 */
-- View: gipse_view_bs_va

-- DROP VIEW ${db.schema}.gipse_view_bs_va;

CREATE OR REPLACE VIEW ${db.schema}.gipse_view_bs_va AS 
...
ALTER TABLE ${db.schema}.gipse_view_bs_va OWNER TO ${db.owner};
