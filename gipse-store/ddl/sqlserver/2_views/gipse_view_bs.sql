...
WHERE ${db.schema}.gipse_store.data_source_id in (1,2,3,4)               

GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'View that limits observations to only those loaded from the BioSense extract.' , @level0type=N'SCHEMA',@level0name=N'${db.schema}', @level1type=N'VIEW',@level1name=N'gipse_view_bs'