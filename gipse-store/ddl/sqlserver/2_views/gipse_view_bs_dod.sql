...
GO
CREATE VIEW [${db.schema}].[gipse_view_bs_dod]
AS
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'View that limits observations to only those loaded from the BioSense DoD extract.' , @level0type=N'SCHEMA',@level0name=N'${db.schema}', @level1type=N'VIEW',@level1name=N'gipse_view_bs_dod'