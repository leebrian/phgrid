...
GO
CREATE VIEW [${db.schema}].[gipse_view_bs_hie_sa]
AS
...
WHERE ${db.schema}.gipse_store.data_source_id = 5 --HIE-SA in data source table               

GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'View that limits observations to only those loaded from the HIE-SA/NHIN extract.' , @level0type=N'SCHEMA',@level0name=N'${db.schema}', @level1type=N'VIEW',@level1name=N'gipse_view_bs_hie_sa'