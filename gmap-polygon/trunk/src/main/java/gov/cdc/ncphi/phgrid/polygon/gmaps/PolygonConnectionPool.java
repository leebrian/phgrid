 ...
 *
 */
public class PolygonConnectionPool 
{
	private Connection con;
	private static String PROPERTIES_FILE = "/gmap-polygon.properties";
	private String  tableName, centroidTableName;
	private Properties defaultProps;
	private static final Logger logger = Logger.getLogger(PolygonConnectionPool.class);
